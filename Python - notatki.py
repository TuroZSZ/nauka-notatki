...
# Zmienne w pythonie mogą zawierać jedynie litery, cyfry i podkreślniki. Nie mogą to być słowa kluczowe pythona i nie mogą 
# rozpoczynać się od cyfr.
...
# Jeśli myfunc() byłoby z tabem (pod definicją) to komenda print weźmie ogólną zmienną x = "awesome", ponieważ x="fantasic" 
# będzie wewnętrzną.
...
# Określenie typu zmiennej - czasem dochodzi do sytuacji, że z góry chcemy określić rodzaj zmiennej. Można to zrobić poprzez:
